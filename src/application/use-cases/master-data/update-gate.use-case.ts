...
import { UpdateGateDto } from '../../dtos/master-data/master-data-list-update.dto.js';
...
export class UpdateGateUseCase {
  ...
  async execute(
    ...
    const entity = await this.repo.updateGate(id, data);
    return GateResponseDto.fromEntity(entity);
  }
}
