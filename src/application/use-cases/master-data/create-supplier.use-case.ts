...
import { CreateSupplierDto } from '../../dtos/master-data/master-data-request.dto.js';
import { SupplierResponseDto } from '../../dtos/master-data/master-data-response.dto.js';
...
export class CreateSupplierUseCase {
  ...
  async execute(actorId: string, data: CreateSupplierDto): Promise<SupplierResponseDto> {
    await requirePermission(this.users, actorId, PermissionCode.MANAGE_MASTER_DATA);
    return SupplierResponseDto.fromEntity(await this.repo.createSupplier(data));
  }
}
