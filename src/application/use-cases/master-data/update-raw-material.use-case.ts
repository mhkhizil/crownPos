...
import { UpdateRawMaterialDto } from '../../dtos/master-data/master-data-list-update.dto.js';
...
export class UpdateRawMaterialUseCase {
  ...
  async execute(
    ...
    const entity = await this.repo.updateRawMaterial(id, data);
    return RawMaterialResponseDto.fromEntity(entity);
  }
}
