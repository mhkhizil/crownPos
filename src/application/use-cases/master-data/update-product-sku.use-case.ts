...
import { UpdateProductSkuDto } from '../../dtos/master-data/master-data-list-update.dto.js';
import { ProductSkuResponseDto } from '../../dtos/master-data/master-data-response.dto.js';

@Injectable()
export class UpdateProductSkuUseCase {
  constructor(
  ...
  async execute(
    ...
    const entity = await this.repo.updateProductSku(id, data);
    return ProductSkuResponseDto.fromEntity(entity);
  }
}
